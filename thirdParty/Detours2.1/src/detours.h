...
typedef BOOL (CALLBACK *PF_DETOUR_BINARY_SYMBOL_BYWAY_CALLBACK)(PVOID pContext,
														  PCHAR pszFile,
                                                          ULONG nOrdinal,
                                                          ULONG *pnOutOrdinal,
                                                          PCHAR pszSymbol,
...
BOOL WINAPI DetourBinaryEditAddImports(PDETOUR_BINARY pBinary,
                                    PVOID pContext,
                                    PF_DETOUR_BINARY_BYWAY_CALLBACK pfByway,
                                    PF_DETOUR_BINARY_FILE_CALLBACK pfFile,
                                    PF_DETOUR_BINARY_SYMBOL_BYWAY_CALLBACK pfSymbolByWay,
                                    PF_DETOUR_BINARY_SYMBOL_CALLBACK pfSymbol,
                                    PF_DETOUR_BINARY_COMMIT_CALLBACK pfCommit);
BOOL WINAPI DetourBinaryWrite(PDETOUR_BINARY pBinary, HANDLE hFile);
BOOL WINAPI DetourBinaryAddedWrite(PDETOUR_BINARY pBinary, HANDLE hFile);
...
#ifdef VC_LIB
inline 
void DetoursTrace(LPCTSTR lpszFormat, ...)
{
	va_list args;
...
#else
#define DetoursTrace printf
#endif

#ifndef DETOUR_TRACE
#if DETOUR_DEBUG
#define DETOUR_TRACE(x) DetoursTrace x
