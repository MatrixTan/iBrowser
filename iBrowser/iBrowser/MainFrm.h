...
public:
	...
	static const DWORD kStyle = WS_POPUP|WS_VISIBLE|WS_CLIPSIBLINGS|WS_CLIPCHILDREN|WS_BORDER|WS_SYSMENU|WS_THICKFRAME|WS_MAXIMIZEBOX|WS_MAXIMIZEBOX;
	static const DWORD kExStyle = WS_EX_LEFT|WS_EX_LTRREADING|WS_EX_RIGHTSCROLLBAR|WS_EX_WINDOWEDGE;
